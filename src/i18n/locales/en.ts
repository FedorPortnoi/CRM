const en = {
  auth: {
    ...
    joinSubtitle: 'Enter the email and temporary password your manager gave you.',
    tempPassword: 'Temporary password',
    joinButton: 'Sign in',
    backToLogin: '← Back',
    setPasswordTitle: 'Welcome, {{name}}!',
    setPasswordSubtitle: 'Set your own password to continue.',
    tempPasswordCurrent: 'Current (temporary) password',
