...
export default function ChatRoomScreen() {
  ...
  }, [channelMessages, currentUser?.id]);
  ...
  return (
    ...
    >
      <FlatList
        ...
        ListFooterComponent={loadingMore ? <ActivityIndicator style={{ margin: 16 }} color="#C45A10" /> : null}
        ListEmptyComponent={
...
const styles = StyleSheet.create({
  ...
  senderName: { fontSize: 12, color: '#B07868', fontWeight: '600', marginBottom: 3, marginLeft: 4 },
  bubbleInner: {
  ...
  bubbleInnerMine: { backgroundColor: '#C45A10', borderBottomRightRadius: 4 },
  bubbleInnerOther: { backgroundColor: '#fff', borderBottomLeftRadius: 4 },
  bubbleText: { fontSize: 15, color: '#383432', lineHeight: 20, flexShrink: 1 },
  bubbleTextMine: { color: '#fff' },
  bubbleTime: { fontSize: 11, color: '#CFADA3', alignSelf: 'flex-end' },
  bubbleTimeMine: { color: 'rgba(255,255,255,0.7)' },
  emptyWrap: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 40 },
  emptyText: { color: '#CFADA3', fontSize: 14 },
  inputBar: {
    flexDirection: 'row', alignItems: 'flex-end',
    backgroundColor: '#fff', paddingHorizontal: 12, paddingVertical: 10,
    borderTopWidth: 1, borderTopColor: '#F5EDE8', gap: 8,
  },
  input: {
    flex: 1, minHeight: 40, maxHeight: 120,
    backgroundColor: '#FAF6F3', borderRadius: 20, borderWidth: 1,
    borderColor: '#E8DDD6', paddingHorizontal: 16, paddingVertical: 10,
    fontSize: 15, color: '#383432',
  },
  sendBtn: {
    width: 40, height: 40, borderRadius: 20,
    backgroundColor: '#C45A10', alignItems: 'center', justifyContent: 'center',
  },
  sendBtnDisabled: { backgroundColor: '#E8DDD6' },
});
