...
const styles = StyleSheet.create({
  ...
  triggerRow: { minHeight: 48, borderRadius: 8, borderWidth: 1, borderColor: '#D1D5DB', backgroundColor: '#FFFFFF', justifyContent: 'center', paddingHorizontal: 12, marginBottom: 8 },
  triggerRowSelected: { borderColor: '#1A73E8', backgroundColor: '#E8F0FE' },
  ...
  retryBtn: { height: 48, borderRadius: 8, backgroundColor: '#1A73E8', alignItems: 'center', justifyContent: 'center', marginTop: 16, paddingHorizontal: 32 },
  primaryBtn: { flex: 1, height: 48, borderRadius: 8, backgroundColor: '#1A73E8', alignItems: 'center', justifyContent: 'center', marginTop: 16 },
  primaryBtnText: { color: '#FFFFFF', fontWeight: '700', fontSize: 16 },
  btnDisabled: { opacity: 0.5 },
  secondaryBtn: { height: 48, borderRadius: 8, borderWidth: 1, borderColor: '#1A73E8', alignItems: 'center', justifyContent: 'center', marginTop: 12 },
  secondaryBtnText: { color: '#1A73E8', fontWeight: '700' },
  skipBtn: { flex: 1, height: 48, borderRadius: 8, borderWidth: 1, borderColor: '#D1D5DB', alignItems: 'center', justifyContent: 'center', marginTop: 16, marginRight: 8 },
  ...
  pickerRow: { height: 44, borderRadius: 8, borderWidth: 1, borderColor: '#D1D5DB', justifyContent: 'center', paddingHorizontal: 12, marginBottom: 6 },
  pickerRowSelected: { borderColor: '#1A73E8', backgroundColor: '#E8F0FE' },
});
