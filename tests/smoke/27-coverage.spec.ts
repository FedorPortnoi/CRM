...
test("concurrent: 8 parallel contact creates all return 201 with unique IDs", async ({ request }) => {
  const org = await registerVerifiedOrg(request, 'c27cc1');
...
test("concurrent: 6 parallel task creates all return 201 with unique IDs", async ({ request }) => {
  const org = await registerVerifiedOrg(request, 'c27ct1');
...
test("concurrent: 5 parallel calendar event creates all return 201", async ({ request }) => {
  const org = await registerVerifiedOrg(request, 'c27ccal1');
...
test("concurrent: 5 parallel deal creates all return 201 with unique IDs", async ({ request }) => {
  const org = await registerVerifiedOrg(request, 'c27cd1');
...
test("concurrent: 5 tasks completed in parallel all return 200", async ({ request }) => {
  const org = await registerVerifiedOrg(request, 'c27ccomp1');
...
test("concurrent: 7 parallel GET /contacts all return 200", async ({ request }) => {
  const org = await registerVerifiedOrg(request, 'c27clist1');
...
test("concurrent: 5 parallel pipeline creates all return 201 with unique IDs", async ({ request }) => {
  const org = await registerVerifiedOrg(request, 'c27cpl1');
  const rs = await Promise.all(Array.from({ length: 5 }, (_, i) =>
...
test("concurrent: 10 parallel contact list queries return same total", async ({ request }) => {
  const org = await registerVerifiedOrg(request, 'c27cq1');
...
test("cross-org: org B cannot GET org A contact by ID", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA1");
  const orgB = await registerVerifiedOrg(request, "c27cgB1");
...
test("cross-org: org B cannot PATCH org A contact", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA2");
  const orgB = await registerVerifiedOrg(request, "c27cgB2");
...
test("cross-org: org B cannot DELETE org A contact", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA3");
  const orgB = await registerVerifiedOrg(request, "c27cgB3");
...
test("cross-org: org B cannot GET org A deal by ID", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA4");
  const orgB = await registerVerifiedOrg(request, "c27cgB4");
...
test("cross-org: org B cannot PATCH org A deal", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA5");
  const orgB = await registerVerifiedOrg(request, "c27cgB5");
  const pl = await getPipeline(request, orgA.token);
...
test("cross-org: org B cannot mark org A deal as won", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA6");
  const orgB = await registerVerifiedOrg(request, "c27cgB6");
  const pl = await getPipeline(request, orgA.token);
...
test("cross-org: org B cannot mark org A deal as lost", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA6b");
  const orgB = await registerVerifiedOrg(request, "c27cgB6b");
  const pl = await getPipeline(request, orgA.token);
...
test("cross-org: org B cannot GET org A task by ID", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA7");
  const orgB = await registerVerifiedOrg(request, "c27cgB7");
...
test("cross-org: org B cannot complete org A task", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA8");
  const orgB = await registerVerifiedOrg(request, "c27cgB8");
...
test("cross-org: org B cannot PATCH org A task", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA9");
  const orgB = await registerVerifiedOrg(request, "c27cgB9");
...
test("cross-org: org B cannot GET org A pipeline by ID", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA10");
  const orgB = await registerVerifiedOrg(request, "c27cgB10");
  const pl = await getPipeline(request, orgA.token);
...
test("cross-org: org B cannot delete org A pipeline", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA11");
  const orgB = await registerVerifiedOrg(request, "c27cgB11");
...
test("cross-org: org B cannot list stages of org A pipeline", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA12");
  const orgB = await registerVerifiedOrg(request, "c27cgB12");
  const pl = await getPipeline(request, orgA.token);
...
test("cross-org: org B calendar events absent from org A list", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA13");
  const orgB = await registerVerifiedOrg(request, "c27cgB13");
...
test("cross-org: org B cannot add stage to org A pipeline", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA14");
  const orgB = await registerVerifiedOrg(request, "c27cgB14");
  const pl = await getPipeline(request, orgA.token);
...
test("cross-org: org B deal list excludes org A deals", async ({ request }) => {
  const orgA = await registerVerifiedOrg(request, "c27cgA15");
  const orgB = await registerVerifiedOrg(request, "c27cgB15");
  const pl = await getPipeline(request, orgA.token);
...
test("deal SM: open to won to re-won returns 422 DEAL_ALREADY_WON", async ({ request }) => {
  const org = await registerVerifiedOrg(request, "c27smW1");
  const pl = await getPipeline(request, org.token);
...
test("deal SM: open to lost to re-lost returns 422 DEAL_ALREADY_LOST", async ({ request }) => {
  const org = await registerVerifiedOrg(request, "c27smL1");
  const pl = await getPipeline(request, org.token);
...
test("deal SM: won deal cannot be moved to stage returns 422 DEAL_NOT_OPEN", async ({ request }) => {
  const org = await registerVerifiedOrg(request, "c27smWM1");
  const pl = await getPipeline(request, org.token);
...
test("deal SM: archived deal cannot be moved to stage returns 422 DEAL_NOT_OPEN", async ({ request }) => {
  const org = await registerVerifiedOrg(request, "c27smAM1");
  const pl = await getPipeline(request, org.token);
...
test("deal SM: re-archiving archived deal returns 422 DEAL_ALREADY_ARCHIVED", async ({ request }) => {
  const org = await registerVerifiedOrg(request, "c27smRA1");
  const pl = await getPipeline(request, org.token);
...
test("task SM: cancelled task cannot be started returns 422 INVALID_STATUS_TRANSITION", async ({ request }) => {
  const org = await registerVerifiedOrg(request, "c27smTC1");
...
test("task SM: pending to in_progress verified on GET", async ({ request }) => {
  const org = await registerVerifiedOrg(request, "c27smTI1");
...
test("task SM: re-completing done task returns 200 or 422", async ({ request }) => {
  const org = await registerVerifiedOrg(request, "c27smTD1");
